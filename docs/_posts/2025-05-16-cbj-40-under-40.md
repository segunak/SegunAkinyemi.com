...
<script type="application/ld+json">
{
  ...
  "description": "Charlotte Business Journal 40 Under 40 2025 print feature of Segun Akinyemi, Senior Software Engineer at Microsoft",
  "creditText": "Charlotte Business Journal",
  "creator": {
    "@type": "Person",
    "name": "Segun Akinyemi"
  }
...
You can view the print version [here](https://segunakinyemi.com/assets/images/NewspaperPage-40Under40.jpg), but since I wrote and submitted the content myself (and I tend to be a bit verbose—which you'll notice if you poke around this blog), the Business Journal did some light editing of my responses. However, you can read the unedited version in its full glory below!
