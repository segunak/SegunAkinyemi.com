...
last_modified_at: 2023-12-16T18:28:21
#classes: wide
toc: true
...
2. Your team is both mature and with the times, so instead of giving a few people `db_owner` and trusting them with the arduous error-prone task of continuous updates via ad hoc scripts, you instead manage changes programmatically via a [SQL Server Database Project](https://learn.microsoft.com/en-us/sql/ssdt/how-to-create-a-new-database-project){:target="_blank"}.
